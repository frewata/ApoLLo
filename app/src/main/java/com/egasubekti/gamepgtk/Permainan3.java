...
public class Permainan3 extends AppCompatActivity {
    ...
    public int bound=50; //batas array soal maksimal
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permainan3);
...
//        Toast.makeText(this, "nomor soal :"+mQuestionNumber, Toast.LENGTH_SHORT).show();
    ...
    {
        String soalBenar = QuestionLibraryHewan.getQuestion(a);
