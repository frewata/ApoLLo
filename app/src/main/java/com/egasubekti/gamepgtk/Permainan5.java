...
import com.egasubekti.gamepgtk.Library.QuestionLibraryTransport;
...
public class Permainan5 extends AppCompatActivity {
    ...
    private QuestionLibraryTransport mQuestionLibrary= new QuestionLibraryTransport();
...
//        String test = mQuestionLibrary.getCorrectAnswer(0);
//        int test = mQuestionNumber;
...
//        Toast.makeText(getApplicationContext(),"pilihan1 :"+pilihan1, Toast.LENGTH_LONG).show();
        ...
        Collections.shuffle(shuffle); //acak pilihan
        int fixWidth = btn1.getDrawable().getIntrinsicWidth();
...
//        Toast.makeText(this, "nomor soal :"+mQuestionNumber, Toast.LENGTH_SHORT).show();
    }
    public void setSoal(int a)
    {
        String soalBenar = QuestionLibraryTransport.getQuestion(a);
