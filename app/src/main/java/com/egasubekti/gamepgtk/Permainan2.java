...
import com.egasubekti.gamepgtk.Library.QuestionLibraryBuah;
...
public class Permainan2 extends AppCompatActivity {
    ...
    public int bound=16; //batas array soal maksimal
    String jawaban1,jawaban2,jawaban3,jawaban4;
    public Integer i;
    String jawaban, mAnswer;
    private QuestionLibraryBuah mQuestionLibrary= new QuestionLibraryBuah();
...
//        Toast.makeText(this, "nomor soal :"+mQuestionNumber, Toast.LENGTH_SHORT).show();
    ...
    {
        String soalBenar = QuestionLibraryBuah.getQuestion(a);
